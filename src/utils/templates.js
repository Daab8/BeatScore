      ...
      <body>
        <div style="width: fit-content;">
          ...
          <div style="text-align: right; padding-top: 25px">
            ${changeTime ? `<span>Changes since: <b style="margin-left: 5px;">${new Date(changeTime - new Date(changeTime).getTimezoneOffset() * 60000).toISOString().replace(/T/, ' ').replace(/\..+/, '')}</b></span>` : ''}
